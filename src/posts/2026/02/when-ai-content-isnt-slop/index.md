...
I've been thinking about this because of my own project. [Educates](https://github.com/educates/educates-training-platform/) is an interactive training platform I've been working on for over five years (I mentioned it briefly in my [earlier post](/posts/2025/09/back-from-the-dead/) when I started writing here again). It's designed for hands-on technical workshops where people learn by doing, not just by reading.
